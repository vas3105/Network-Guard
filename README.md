...
- dlp.py (last line) sniff(iface="Software Loopback Interface 1", prn=inspect_packet, store=0)
- sudo python dlp.py
- python server.py
- host the html locally in  http://localhost:8000 and submit a sample test
